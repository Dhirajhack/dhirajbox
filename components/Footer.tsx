...
export const Footer = () => {
    return (
        <footer className="bg-black/20 text-gray-400 mt-16">
            <div className="container mx-auto px-6 py-6">
                <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    <div className="text-center md:text-left">
                        <h3 className="text-lg text-white font-bold">MysteryBox</h3>
                ...
                <div className="mt-6 border-t border-gray-700 pt-4 flex flex-col sm:flex-row justify-between items-center text-xs">
