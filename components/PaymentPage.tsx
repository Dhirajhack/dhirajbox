...
Order placed from website. Please find payment screenshot attached.
  ...
  return (
    <div className="min-h-screen text-gray-800 flex justify-center items-center py-12 px-4 animate-fade-in-up" style={{ animation: 'fade-in-up 0.5s ease-out' }}>
        <div className="w-full max-w-4xl flex flex-col md:flex-row bg-white rounded-2xl shadow-2xl shadow-gray-400/20 overflow-hidden border border-gray-200">
            {/* Left Side: Order Summary */}
            <div className="md:w-1/2 p-8 bg-gray-50">
                <button onClick={onGoBack} className="flex items-center space-x-1 text-gray-500 hover:text-yellow-500 transition-colors mb-6">
                ...
                <div className="flex items-center space-x-4 border-b border-gray-200 pb-4">
                    ...
                    <div>
                        <h3 className="font-semibold text-lg text-gray-800">{box.name}</h3>
                        <p className="text-yellow-500 font-bold text-xl">₹{box.price.toLocaleString('en-IN')}</p>
                    </div>
                </div>
                <div className="space-y-2 text-gray-600 mt-4">
                    ...
                    <div className="flex justify-between text-gray-900 font-bold text-lg border-t border-gray-200 pt-2 mt-2"><span>Total</span><span>₹{total.toLocaleString('en-IN')}</span></div>
                </div>
            ...
            <div className="md:w-1/2 p-8 flex flex-col justify-center">
                    ...
                    <div>
                        ...
                        <div className="p-4 bg-gray-100 rounded-lg border border-gray-200">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-xl font-bold text-yellow-500">₹{total.toLocaleString('en-IN')}</span>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center justify-center mt-4 text-gray-500 text-sm space-x-2">
                            <ShieldCheckIcon />
                ...
                {paymentStep === 'upload' && (
                    <div>
                        ...
                        <p className="text-gray-600 mb-6 text-sm">Please upload a screenshot of your successful payment to finalize the order.</p>
                        
                        <div>
                            <label htmlFor="file-upload" className="relative cursor-pointer bg-gray-100 rounded-md font-medium text-yellow-600 hover:text-yellow-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-white focus-within:ring-yellow-500 border-2 border-dashed border-gray-300 h-40 flex items-center justify-center text-center p-1">
                                {proofPreview ? (
                        ...
                        <div className="mt-2">
                            <button 
                                ...
                                className="w-full bg-green-500 text-white font-bold py-4 rounded-lg text-lg transition-all duration-300 shadow-lg hover:shadow-green-500/40 disabled:bg-gray-400 disabled:text-white/80 disabled:cursor-not-allowed disabled:shadow-none flex items-center justify-center space-x-3"
                            >
                ...
                {paymentStep === 'confirming' && (
                    <div>
                        ...
                        <p className="text-gray-600 mb-6 text-sm">We've opened WhatsApp for you. Please attach your payment screenshot in the chat and send the message to confirm your order.</p>
                        
                        <div className="p-4 bg-blue-50 rounded-lg border border-blue-200 text-center flex flex-col items-center space-y-3">
                            ...
                            <p className="font-semibold text-blue-700">Waiting for you to send the message on WhatsApp...</p>
                        </div>
